...
export default function SidebarNav({ activePanel, onSelect }: { activePanel: MobileWarRoomPanel; onSelect: (panel: MobileWarRoomPanel) => void }) {
  return (
    <aside className="hidden min-h-screen w-72 shrink-0 border-r border-white/[0.055] bg-[#111314]/92 p-4 backdrop-blur-2xl xl:block">
      <div className="trade-panel rounded-2xl p-4">
        <div className="flex items-center gap-3">
          <div className="grid h-12 w-12 place-items-center rounded-xl bg-trade-green/[0.09] text-xl font-black text-emerald-100 ring-1 ring-trade-green/[0.18]">TB</div>
          <div>
      ...
      <div className="mt-5 space-y-3">
        <div className="rounded-2xl bg-[#ff4d5e]/[0.075] p-4 text-red-50 ring-1 ring-[#ff4d5e]/[0.18]">
